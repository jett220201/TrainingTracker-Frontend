...
function Register() {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden">
            <VideoBackground />
            <div className="relative z-20 flex w-full h-full flex-col items-center justify-start overflow-y-auto">
                <div className="flex flex-col items-center justify-center">
                    <div className="flex flex-col items-center justify-start my-4 gap-6 lg:gap-4">
                        <Header subtitle={t("registerHeaderMessage")} subtitleColor="text-gray-200" titleColor="text-gray-100" />
                        ...
                        <section className="flex flex-col items-start justify-center bg-white rounded-md shadow-xl p-6 gap-2 w-xs lg:w-fit">
                            ...
                            <div>
                                <form className="flex flex-col lg:w-90 mt-4 gap-2" onSubmit={handleRegister}>
                                    <div>
