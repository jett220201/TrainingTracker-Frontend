...
function getTypeClassname(type: Alert) {
    switch (type) {
        case "Error":
            return {
                containerClass: 'flex flex-row border-1 border-red-500 bg-red-50 dark:bg-slate-900 rounded-md p-2 items-center gap-2 w-xs lg:w-100',
        ...
        case "Success":
            return {
                containerClass: 'flex flex-row border-1 border-green-500 bg-green-50 dark:bg-slate-900 rounded-md p-2 items-center gap-2 w-xs lg:w-100',
        ...
        case "Warning":
            return {
                containerClass: 'flex flex-row border-1 border-yellow-500 dark:border-yellow-200 bg-yellow-50 dark:bg-slate-900 rounded-md p-2 items-center gap-2 w-xs lg:w-100',
        ...
        default:
            return {
                containerClass: 'flex flex-row border-1 border-blue-500 dark:border-blue-200 bg-blue-50 dark:bg-slate-900 rounded-md p-2 items-center gap-2 w-xs lg:w-100',
